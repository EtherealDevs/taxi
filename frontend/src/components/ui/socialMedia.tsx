...
export default function SocialMediaLinks() {
    ...
    return (
        <div className="fixed bottom-4 right-8 z-50">
            ...
            {isOpen && (
                <div className="absolute bottom-14 right-0 p-4 rounded-lg flex flex-col items-center justify-center space-y-3">
                    <a href="https://wa.me/5493757417857" target="_blank" rel="noopener noreferrer" className="text-green-500 hover:text-green-600 transition duration-300 transform hover:scale-110">
                    ...
                    <a href="https://www.instagram.com/nelsonolivera.viajes/" target="_blank" rel="noopener noreferrer" className="text-pink-500 hover:text-pink-600 transition duration-300 transform hover:scale-110">
