"use client";
const AnimatedLoadingWheel = () => {
  return (
    <div className="grid h-[90vh] place-content-center">
      <div className="relative flex items-center justify-center h-32 w-32 overflow-hidden">
        <svg
        ...
        {/* Carretera animada */}
        <div className="absolute bottom-0 w-full h-1 bg-gray-700 animate-[roadMove_2s_linear_infinite]"></div>
