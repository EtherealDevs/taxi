  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      rating: 5,
      message:
        "Excelente servicio, muy puntual y profesional. El vehículo estaba impecable.",
      date: "2024-01-15",
      tripId: "trip1",
    },
    {
      ...
      rating: 4,
      message:
        "Buen servicio en general, aunque hubo un pequeño retraso en la recogida.",
      date: "2024-01-14",
      tripId: "trip2",
    },
    {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="bg-white dark:bg-neutral-800 rounded-lg shadow overflow-hidden">
        {/* Contenedor de las filas transformadas en tarjetas en móviles */}
        <div className="sm:hidden">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="border-b border-gray-200 dark:border-neutral-700 p-4"
            >
              ...
              <div className="mt-3">
                ...
                <p className="text-sm mt-2 line-clamp-3">{review.message}</p>
        ...
        {/* Tabla tradicional para pantallas grandes */}
            ...
            <TableBody>
              {reviews.map((review) => (
                <motion.tr
                  ...
                  exit={{ opacity: 0, y: -20 }}
                  className="group hover:bg-gray-50 dark:hover:bg-neutral-700"
                >
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <Image
