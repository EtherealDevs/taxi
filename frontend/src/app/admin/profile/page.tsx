            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {drivers?.map((driver) => (
                    ...
                    >
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">{driver.name}</h3>
                            {/* <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">{driver.car}</p> */}
                            <div className="flex flex-wrap gap-2 mb-4">

                                <span
                                    className="px-2 py-1 bg-gray-100 dark:bg-neutral-700 rounded-full text-xs text-gray-600 dark:text-gray-300"
                                >
                                    {driver.languages}
                                </span>
                            </div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <Button onClick={() => handleDelete(driver.id)} variant="destructive" size="icon">
